package com.arman.efficientqhalgoforch.common.concurrent.search;
...
public class ForkedExtrema extends ForkableSearch<Point2D, List<Point2D>> {
     ...
     * Implementation
     */
    public class Reference extends com.arman.efficientqhalgoforch.common.Reference<Point2D> {
    ...
    @Override
    protected com.arman.efficientqhalgoforch.common.Reference getReferenceInstance() {
        return new Reference(null);
    }

    @Override
    protected void onSearch(int start, int end, com.arman.efficientqhalgoforch.common.Reference ref) {
        Point2D max = null;
        int maxIndex = -1;
