...
/**
 * {@link com.computation.common.Console} is the logging system. A Console object will can be requested by each
 * class in order to the write to the system declared default {@link PrintWriter}. This
 * state currently only two basic functions:
 * <ul>
 * <li>{@link com.computation.common.Console#log(Object)}
 * <li>{@link com.computation.common.Console#err(Object)}
 * </ul>
 * <p>
 * 
...
public class Console {
	...
	/**
	 * Returns an instance of {@link com.computation.common.Console} object specified by that
	...
	/**
	 * Constructor used for invocation by {@link com.computation.common.Console#getInstance(Class)}
	 * 
	 * @see com.computation.common.Console#getInstance(Class)
	 */
