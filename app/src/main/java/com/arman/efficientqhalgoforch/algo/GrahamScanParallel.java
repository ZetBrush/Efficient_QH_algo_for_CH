...
import com.arman.efficientqhalgoforch.common.concurrent.search.ForkedMaxBottomLeft;
import com.arman.efficientqhalgoforch.external.DoneListener;
import com.arman.efficientqhalgoforch.external.HeavySort;
...
public class GrahamScanParallel extends ConvexHull {
    ...
    public GrahamScanParallel(Point2DCloud pointCloud, int threads,
                              boolean debug, int animationDelay,DoneListener listener) {
